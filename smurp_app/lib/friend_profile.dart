...
class FriendProfileState extends State<FriendProfilePage> {
  ...
  Future<String> getProfileData() async {
    http.Response response = await http.get(
        "http://ec2-52-91-42-119.compute-1.amazonaws.com:5000/getfeed?user_id="+globals.friend_id.toString()+"&user_only=true"+"&session_key="+globals.session_key,
  ...
  Future<String> getUserData() async {
    http.Response response = await http.get(
        "http://ec2-52-91-42-119.compute-1.amazonaws.com:5000/get_user?user_id="+globals.friend_id.toString()+"&session_key="+globals.session_key,
        headers: {"Accept": "application/json"});
